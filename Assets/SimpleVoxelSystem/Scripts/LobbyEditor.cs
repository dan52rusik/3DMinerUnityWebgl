...
namespace SimpleVoxelSystem
{
    ...
    public class LobbyEditor : MonoBehaviour
    {
        ...
        public void LoadAndApplyLayout()
        {
            ...
            for (int cz = 0; cz < Mathf.CeilToInt((float)island.TotalZ / ChunkSize); cz++)
            {
                ...
                foreach (var e in data.entries)
                    island.SetVoxel(e.x, e.y, e.z, (BlockType)BlockTypeCatalog.ClampStoredTypeId(e.blockTypeId));
                loaded++;
            }
        ...
        private Color GetSelectedBlockPreviewColor() { return BlockTypeCatalog.GetColor(selectedBlockType); }
