...
namespace SimpleVoxelSystem
{
    ...
    public static class Loc
    {
        ...
        private static void SeedCoreTranslations()
        {
            ...
            Set("btn_build", LangBe, "БУДАВАЦЬ");
            Set("btn_build", LangBg, "СТРОИ");
            Set("btn_build", LangCa, "CONSTRUEIX");
            Set("btn_build", LangCs, "STAVĚT");
            Set("btn_build", LangDe, "BAUEN");
            Set("btn_build", LangEs, "CONSTRUIR");
            Set("btn_build", LangFa, "ساخت");
            Set("btn_build", LangFr, "CONSTRUIRE");
            Set("btn_build", LangHe, "בנה");
            Set("btn_build", LangHi, "बनाओ");
            Set("btn_build", LangHu, "ÉPÍTÉS");
            Set("btn_build", LangHy, "ԿԱՌՈՒՑԵԼ");
            Set("btn_build", LangId, "BANGUN");
            Set("btn_build", LangIt, "COSTRUISCI");
            Set("btn_build", LangJa, "建築");
            Set("btn_build", LangKa, "აშენება");
            Set("btn_build", LangKk, "ҚҰРУ");
            Set("btn_build", LangNl, "BOUWEN");
            Set("btn_build", LangPl, "BUDUJ");
            Set("btn_build", LangPt, "CONSTRUIR");
            Set("btn_build", LangRo, "CONSTRUIEȘTE");
            Set("btn_build", LangSk, "STAVAŤ");
            Set("btn_build", LangSr, "GRADI");
            Set("btn_build", LangTh, "สร้าง");
            Set("btn_build", LangTk, "GUR");
            Set("btn_build", LangUk, "БУДУВАТИ");
            Set("btn_build", LangUz, "QURISH");
            Set("btn_build", LangVi, "XÂY");
            Set("btn_build", LangZh, "建造");

            Set("build_inventory", LangAr, "مخزون البناء");
            Set("build_inventory", LangAz, "Tikinti inventarı");
            Set("build_inventory", LangBe, "Будаўнічы інвентар");
            Set("build_inventory", LangBg, "Строителен инвентар");
            Set("build_inventory", LangCa, "Inventari de construcció");
            Set("build_inventory", LangCs, "Stavební inventář");
            Set("build_inventory", LangDe, "Bauinventar");
            Set("build_inventory", LangEs, "Inventario de construcción");
            Set("build_inventory", LangFa, "موجودی ساخت‌وساز");
            Set("build_inventory", LangFr, "Inventaire de construction");
            Set("build_inventory", LangHe, "מלאי בנייה");
            Set("build_inventory", LangHi, "निर्माण भंडार");
            Set("build_inventory", LangHu, "Építési készlet");
            Set("build_inventory", LangHy, "Կառուցման գույք");
            Set("build_inventory", LangId, "Inventaris bangunan");
            Set("build_inventory", LangIt, "Inventario costruzione");
            Set("build_inventory", LangJa, "建築インベントリ");
            Set("build_inventory", LangKa, "სამშენებლო ინვენტარი");
            Set("build_inventory", LangKk, "Құрылыс қоржыны");
            Set("build_inventory", LangNl, "Bouwinventaris");
            Set("build_inventory", LangPl, "Ekwipunek budowy");
            Set("build_inventory", LangPt, "Inventário de construção");
            Set("build_inventory", LangRo, "Inventar de construcție");
            Set("build_inventory", LangSk, "Stavebný inventár");
            Set("build_inventory", LangSr, "Građevinski inventar");
            Set("build_inventory", LangTh, "คลังสร้าง");
            Set("build_inventory", LangTk, "Gurluş inventary");
            Set("build_inventory", LangUk, "Будівельний інвентар");
            Set("build_inventory", LangUz, "Qurilish inventari");
            Set("build_inventory", LangVi, "Kho xây dựng");
            Set("build_inventory", LangZh, "建造库存");

            Set("build_inventory_toggle", LangAr, "بناء");
            Set("build_inventory_toggle", LangAz, "İNŞ");
            Set("build_inventory_toggle", LangBe, "ІНВ");
            Set("build_inventory_toggle", LangBg, "ИНВ");
            Set("build_inventory_toggle", LangCa, "INV");
            Set("build_inventory_toggle", LangCs, "INV");
            Set("build_inventory_toggle", LangDe, "INV");
            Set("build_inventory_toggle", LangEs, "INV");
            Set("build_inventory_toggle", LangFa, "موج");
            Set("build_inventory_toggle", LangFr, "INV");
            Set("build_inventory_toggle", LangHe, "מלאי");
            Set("build_inventory_toggle", LangHi, "सूची");
            Set("build_inventory_toggle", LangHu, "INV");
            Set("build_inventory_toggle", LangHy, "ԳՈՒՅ");
            Set("build_inventory_toggle", LangId, "INV");
            Set("build_inventory_toggle", LangIt, "INV");
            Set("build_inventory_toggle", LangJa, "持物");
            Set("build_inventory_toggle", LangKa, "ინვ");
            Set("build_inventory_toggle", LangKk, "ИНВ");
            Set("build_inventory_toggle", LangNl, "INV");
            Set("build_inventory_toggle", LangPl, "EQ");
            Set("build_inventory_toggle", LangPt, "INV");
            Set("build_inventory_toggle", LangRo, "INV");
            Set("build_inventory_toggle", LangSk, "INV");
            Set("build_inventory_toggle", LangSr, "INV");
            Set("build_inventory_toggle", LangTh, "ช่อง");
            Set("build_inventory_toggle", LangTk, "INV");
            Set("build_inventory_toggle", LangUk, "ІНВ");
            Set("build_inventory_toggle", LangUz, "INV");
            Set("build_inventory_toggle", LangVi, "TÚI");
            Set("build_inventory_toggle", LangZh, "背包");

            Set("build_need_block", LangAr, "البلوك المطلوب: {0}");
            Set("build_need_block", LangAz, "Lazım olan blok: {0}");
            Set("build_need_block", LangBe, "Патрэбны блок: {0}");
            Set("build_need_block", LangBg, "Нужен блок: {0}");
            Set("build_need_block", LangCa, "Cal bloc: {0}");
            Set("build_need_block", LangCs, "Potřebný blok: {0}");
            Set("build_need_block", LangDe, "Benötigter Block: {0}");
            Set("build_need_block", LangEs, "Bloque necesario: {0}");
            Set("build_need_block", LangFa, "بلوک موردنیاز: {0}");
            Set("build_need_block", LangFr, "Bloc requis : {0}");
            Set("build_need_block", LangHe, "בלוק נדרש: {0}");
            Set("build_need_block", LangHi, "ज़रूरी ब्लॉक: {0}");
            Set("build_need_block", LangHu, "Szükséges blokk: {0}");
            Set("build_need_block", LangHy, "Պետք է բլոկ՝ {0}");
            Set("build_need_block", LangId, "Butuh blok: {0}");
            Set("build_need_block", LangIt, "Blocco richiesto: {0}");
            Set("build_need_block", LangJa, "必要なブロック: {0}");
            Set("build_need_block", LangKa, "საჭირო ბლოკი: {0}");
            Set("build_need_block", LangKk, "Қажет блок: {0}");
            Set("build_need_block", LangNl, "Nodig blok: {0}");
            Set("build_need_block", LangPl, "Potrzebny blok: {0}");
            Set("build_need_block", LangPt, "Bloco necessário: {0}");
            Set("build_need_block", LangRo, "Bloc necesar: {0}");
            Set("build_need_block", LangSk, "Potrebný blok: {0}");
            Set("build_need_block", LangSr, "Potreban blok: {0}");
            Set("build_need_block", LangTh, "ต้องใช้บล็อก: {0}");
            Set("build_need_block", LangTk, "Gerek blok: {0}");
            Set("build_need_block", LangUk, "Потрібен блок: {0}");
            Set("build_need_block", LangUz, "Kerakli blok: {0}");
            Set("build_need_block", LangVi, "Cần khối: {0}");
            Set("build_need_block", LangZh, "需要方块：{0}");

            Set("build_island_only", LangAr, "البناء متاح فقط على جزيرتك.");
            Set("build_island_only", LangAz, "Tikinti yalnız öz adanda mümkündür.");
            Set("build_island_only", LangBe, "Будаўніцтва даступна толькі на тваім востраве.");
            Set("build_island_only", LangBg, "Строителството е достъпно само на твоя остров.");
            Set("build_island_only", LangCa, "La construcció només està disponible a la teva illa.");
            Set("build_island_only", LangCs, "Stavět lze pouze na tvém ostrově.");
            Set("build_island_only", LangDe, "Bauen ist nur auf deiner Insel möglich.");
            Set("build_island_only", LangEs, "La construcción solo está disponible en tu isla.");
            Set("build_island_only", LangFa, "ساخت‌وساز فقط روی جزیره خودت ممکن است.");
            Set("build_island_only", LangFr, "La construction n'est disponible que sur ton île.");
            Set("build_island_only", LangHe, "בנייה זמינה רק על האי שלך.");
            Set("build_island_only", LangHi, "निर्माण केवल तुम्हारे द्वीप पर उपलब्ध है।");
            Set("build_island_only", LangHu, "Építeni csak a saját szigeteden lehet.");
            Set("build_island_only", LangHy, "Կառուցելը հասանելի է միայն քո կղզում։");
            Set("build_island_only", LangId, "Membangun hanya tersedia di pulaumu sendiri.");
            Set("build_island_only", LangIt, "Puoi costruire solo sulla tua isola.");
            Set("build_island_only", LangJa, "建築できるのは自分の島だけです。");
            Set("build_island_only", LangKa, "აშენება მხოლოდ შენს კუნძულზეა შესაძლებელი.");
            Set("build_island_only", LangKk, "Құрылыс тек өз аралыңда ғана қолжетімді.");
            Set("build_island_only", LangNl, "Bouwen is alleen mogelijk op je eigen eiland.");
            Set("build_island_only", LangPl, "Budowanie jest dostępne tylko na twojej wyspie.");
            Set("build_island_only", LangPt, "A construção está disponível apenas na sua ilha.");
            Set("build_island_only", LangRo, "Construirea este disponibilă doar pe insula ta.");
            Set("build_island_only", LangSk, "Stavba je dostupná len na tvojom ostrove.");
            Set("build_island_only", LangSr, "Gradnja je dostupna samo na tvom ostrvu.");
            Set("build_island_only", LangTh, "สร้างได้เฉพาะบนเกาะของคุณเท่านั้น");
            Set("build_island_only", LangTk, "Gurluş diňe öz adaňda elýeterlidir.");
            Set("build_island_only", LangUk, "Будувати можна лише на своєму острові.");
            Set("build_island_only", LangUz, "Qurish faqat o‘z orolingizda mumkin.");
            Set("build_island_only", LangVi, "Chỉ có thể xây dựng trên đảo của bạn.");
            Set("build_island_only", LangZh, "只能在你自己的岛上建造。");

            Set("build_place_status", LangAr, "تم البناء: {0}");
            Set("build_place_status", LangAz, "Yerləşdirildi: {0}");
            Set("build_place_status", LangBe, "Пабудавана: {0}");
            Set("build_place_status", LangBg, "Поставено: {0}");
            Set("build_place_status", LangCa, "Col·locat: {0}");
            Set("build_place_status", LangCs, "Umístěno: {0}");
            Set("build_place_status", LangDe, "Platziert: {0}");
            Set("build_place_status", LangEs, "Colocado: {0}");
            Set("build_place_status", LangFa, "ساخته شد: {0}");
            Set("build_place_status", LangFr, "Placée : {0}");
            Set("build_place_status", LangHe, "הוצב: {0}");
            Set("build_place_status", LangHi, "रखा गया: {0}");
            Set("build_place_status", LangHu, "Elhelyezve: {0}");
            Set("build_place_status", LangHy, "Տեղադրվեց՝ {0}");
            Set("build_place_status", LangId, "Ditempatkan: {0}");
            Set("build_place_status", LangIt, "Posizionato: {0}");
            Set("build_place_status", LangJa, "設置: {0}");
            Set("build_place_status", LangKa, "დაიდგა: {0}");
            Set("build_place_status", LangKk, "Орнатылды: {0}");
            Set("build_place_status", LangNl, "Geplaatst: {0}");
            Set("build_place_status", LangPl, "Postawiono: {0}");
            Set("build_place_status", LangPt, "Colocado: {0}");
            Set("build_place_status", LangRo, "Plasat: {0}");
            Set("build_place_status", LangSk, "Umiestnené: {0}");
            Set("build_place_status", LangSr, "Postavljeno: {0}");
            Set("build_place_status", LangTh, "วางแล้ว: {0}");
            Set("build_place_status", LangTk, "Goýuldy: {0}");
            Set("build_place_status", LangUk, "Поставлено: {0}");
            Set("build_place_status", LangUz, "Joylashtirildi: {0}");
            Set("build_place_status", LangVi, "Đã đặt: {0}");
            Set("build_place_status", LangZh, "已放置：{0}");
